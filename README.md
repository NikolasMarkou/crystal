...
The implementation uses Givens rotations applied directly to matrix rows for O(N³) complexity,
making it efficient even for high-dimensional spaces (tested up to 1000D).
